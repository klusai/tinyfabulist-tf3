...
def parse_log(file_path: str) -> Dict[int, Dict[str, float]]:
    ...
    Returns a mapping: step -> {"ce": float, "ppl": float, "agree": float, "throughput": float}
    """
...
def build_series(
    ...
    return steps, ce_series, ppl_series, agree_series, throughput_series
...
def main() -> None:
    ...
    steps, ce, ppl, agree, throughput = build_series(data)
